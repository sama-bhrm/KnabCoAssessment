...
public static class ApiLayerHttpClientFactoryMock
{
    public static IHttpClientFactory GetHttpClientFactoryWithNoClient() => new Mock<IHttpClientFactory>().Object;

    public static IHttpClientFactory GetHttpClientFactoryWithValidResponseContent(GeneralSetting setting, ApiLayerExchangeRatesApiSetting apiSetting)
    {
        ...
        mockHttpClientFactory.Setup(_ => _.CreateClient(HttpClientConstants.ApiLayerHttpClientName)).Returns(httpClient);

        return mockHttpClientFactory.Object;
    }

    public static IHttpClientFactory GetHttpClientFactoryWithUnsuccessfulResult(ApiLayerExchangeRatesApiSetting apiSetting)
    {
        var handlerMock = new Mock<HttpMessageHandler>(MockBehavior.Strict);
        var responseMessage = new HttpResponseMessage
        {
    ...
    public static IHttpClientFactory GetHttpClientFactoryWithError(ApiLayerExchangeRatesApiSetting apiSetting)
    {
        var handlerMock = new Mock<HttpMessageHandler>(MockBehavior.Strict);
        var responseMessage = new HttpResponseMessage
        {
    ...
    public static IHttpClientFactory GetHttpClientFactoryForInvalidCurrency(ApiLayerExchangeRatesApiSetting apiSetting)
    {
        var handlerMock = new Mock<HttpMessageHandler>(MockBehavior.Strict);
        var responseMessage = new HttpResponseMessage
        {
